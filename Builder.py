...
class Builder:
    ...
    def convert(self, num_processes=1, num_cols_per_chunk=None, num_rows_per_save=10):
        ...
        self.__merge_chunk_files(num_processes, line_length, num_rows_per_save)
    ...
    def __merge_chunk_files(self, num_processes, line_length, num_rows_per_save=10):
