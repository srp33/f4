...
class Builder:
    ...
    def __save_rows_chunk(self, column_sizes, chunk_number, start_index, end_index):
        max_line_size = 0
        ...
        with open(f"{self.tmp_dir_path}{chunk_number}", 'wb') as chunk_file:
            with open(f"{self.tmp_dir_path}{chunk_number}_linesizes", 'wb') as size_file:
                ...
                for line in in_file:
                    ...
                    size_file.write((f"{line_size}\n").encode())

        in_file.close()

        return max_line_size

    def __merge_chunk_files(self, num_processes, line_length, num_rows_per_chunk=10):
            ...
            for i in range(num_processes):
                ...
                with open(size_file_path, 'rb') as size_file:
                    ...
                    for size_line in size_file:
                        ...
                        if len(out_lines) % num_rows_per_chunk == 0:
