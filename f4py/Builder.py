...
class Builder:
    ...
    def convert_delimited_file(self, delimited_file_path, f4_file_path, index_columns=[], delimiter="\t", compression_level=22, num_processes=1, num_cols_per_chunk=None, num_rows_per_save=100, tmp_dir_path=None, cache_dir_path=None):
        ...
        if index_columns:
            f4py.IndexHelper.build_indexes(f4_file_path, index_columns, compression_level=compression_level)
    ...
    def _save_meta_files(self, f4_file_path, column_sizes, line_length, column_names=None, column_types=None, compression_level=None, num_rows=None):
        ...
        if column_names:
            ...
            f4py.IndexHelper._customize_values_positions(values_positions, ["c"], f4py.sort_first_column)
    ...
    def _convert_delimited_file_in_chunks(self, delimited_file_path, f4_file_path, delimiter, compression_level, column_sizes, num_rows, num_processes, num_rows_per_save, tmp_dir_path):
        ...
        if num_processes == 1:
            line_length = self._save_rows_chunk(delimited_file_path, delimiter, compression_level, column_sizes, 0, 0, num_rows, num_rows_per_save, tmp_dir_path)
        else:
